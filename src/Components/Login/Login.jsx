        ...
        <div className="card bg-base-100 md:w-1/2 w-full ">
          ...
          <form onSubmit={handleLogin} className="card-body">
            <div className="form-control">
                <h2 className="text-4xl text-center font-bold text-[#ff3811]">Login Now!</h2>
            </div>
            <div className="form-control">
            ...
            <div className="form-control text-center mt-4">
                <p>New to here? Please <span className="text-[#ff3811] font-bold underline"><Link to='/signup'>Sign Up!</Link></span></p>
            </div>
